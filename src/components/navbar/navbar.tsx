        ...
        {role === "admin" && (
          <div className="flex gap-4 justify-end items-center p-4 rounded-lgshadow-sm">
            ...
            <button
              ...
              className="px-5 py-2 text-sm font-medium text-blue-600 border border-blue-600 rounded-lg hover:bg-blue-50 transition-colors duration-200 cursor-pointer"
            >
              Admin Dashboard
            </button>
          </div>
